<template>
  <body class="2xl:mx-auto 2xl:container 2xl:px-20 px-6 overflow-y-hidden py-8">
    <div
      class="
        flex
        md:flex-row
    ...
    >
        ...
        <div class="flex flex-col items-center justify-center">
          ...
          <div class="md:mt-14 mt-12 flex flex-col items-center">
            ...
            <p
              ...
              "
            >
             There is a special place in my heart for community development and progress, as 
             such I have always been compelled to give back to the society in whatever way I can.
            </p>
          </div>
          <div class="mt-7 flex flex-col items-center">
            ...
            <p
              ...
              "
            >
              You can reach me on +260 979 875 897 and email me
              on <span class="text-indigo-300">anjaligupta@gmail.com</span> 
            </p>
          </div>
          <div class="mt-7 flex flex-col items-center">
            <div
          ...
          <div class="mt-7 flex flex-col items-center">
            ...
            <p
              ...
              "
            >
              Being a person that is high in openness, I enjoy being around people with different ideations and goal oriented thought processes, therefore I am open to progressive business partnerships and affiliation.
            </p>
          </div>
        </div>
      </div>
      <div class="py-12 xl:w-1/2 lg:w-1/3 sm:w-1/2">
        <img
          src="https://i.ibb.co/xfVL9HQ/anj1.png"
